 ...
 <?php
       ...
       // $puesto=$_SESSION['puesto'];
        ...
        if ($_SESSION["id"]!=""){
          ...
          $sql="select * from t_tipo_propiedades where f_id='$id'";                                       
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Control Sales | Tipos Pagos</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
              Registro de Tipos de Propiedades
          </h1>
            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Entrada de Tipos de propiedades</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form name="formulario" action="../funciones_PHP/salvar_tipos_pago.php" method="post"
                 onsubmit="return validar()">
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          name="campo_id" id="text_id" value='<?php echo $row['f_id'];?>' readonly/>
                        </div>
                      </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="campo_desc" id="text_desc" value='<?php echo $row['f_descripcion'];?>'/>
                        </div><!-- /.input group -->
                      </div><!-- /.form group -->
                    </div>
                  </div>
                  ...
                  <div class="box-footer">
                     <form action='out_clientes.php'>
                        <input class="btn btn-primary" type="button" value="Cancelar" onClick=" window.location.href='out_tipo_pago.php' ">
                     </form>  
