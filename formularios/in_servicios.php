 ...
 <?php
       ...
       // $puesto=$_SESSION['puesto'];
        ...
        if ($_SESSION["id"]!=""){
          ...
          $sql="select * from t_servicios where f_id='$id'";                                       
            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Entrada de Servicios</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form name="formulario" action="../funciones_PHP/salvar_servicios.php" method="post"
                 onsubmit="return validar()">
                  ...
                  <div class="box-footer">
                     <form action='out_clientes.php'>
                        <input class="btn btn-primary" type="button" value="Cancelar" onClick=" window.location.href='out_servicios.php' ">
                     </form>  
