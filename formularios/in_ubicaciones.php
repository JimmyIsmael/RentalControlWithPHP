 ...
 <?php
       ...
       // $puesto=$_SESSION['puesto'];
        ...
        if ($_SESSION["id"]!=""){
          ...
          $sql="select * from t_ubicaciones where f_id='$id'";                                       
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Control Sales | Ubicaciones</title>
            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Entrada de Ubicaciones</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form name="formulario" action="../funciones_PHP/salvar_ubicaciones.php" method="post"
                 onsubmit="return validar()">
                  ...
                  <div class="box-footer">
                     <form action='out_ubicaciones.php'>
                        <input class="btn btn-primary" type="button" value="Cancelar" onClick=" window.location.href='out_ubicaciones.php' ">
                     </form>  
