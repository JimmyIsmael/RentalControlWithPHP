...
<html>
  <head>
    <meta charset="UTF-8">
    <title>FinancialControl | Servicios Programados</title>
            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Registro de Servicios Programados</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form name="formulario" action="../funciones_PHP/salvar_servicios_programados.php" method="post"
                 onsubmit="return validar()">
                  <div class="box-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="ID Servicio"
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                        <div class="form-group">
                          <label>Dia Compromiso</label>
                          <div class="input-group">
                            <div class="input-group-addon">
                              <i class="fa fa-calendar"></i>
                            </div>
                            <input type="text" class="form-control" 
                          name="campo_compromiso" id="text_compromiso" >
                          </div><!-- /.input group -->
                       </div><!-- /.form group -->
                      </div>
                  ...
                  <div class="box-footer">
                      <form action='out_servicios_programados.php'>
                        <input class="btn btn-primary" type="button" value="Cancelar" onClick=" window.location.href='out_servicios_programados.php' ">
                     </form>  
...
<script>
      function validar(){
       ...
       var count = 0;
        ...
        var  a = document.getElementById('text_compromiso').value;
        //alert("Cojio el valor"); 
        if (a === ''){
            count = count + 1;
            document.getElementById('text_compromiso').style.borderColor = "red";
        }else{document.getElementById('text_compromiso').style.borderColor = "gray";}
