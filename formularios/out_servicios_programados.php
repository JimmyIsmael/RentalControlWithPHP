    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
              Registro de Servicios Programados
          </h1>
        ...
        <div class="col-md-8">
          <div class="box box-primary">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Descripcion del Servicio">
                  </div>
                </div><!-- /.col -->
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-6">
                   <div class="form-group">
                    <form action='in_servicios_programados.php'>
                        ...
                        if ($administrador=="true")
                          {
                            ...
                            $sql="select * from v_servicios_programados";
                          }
                          else
                          { 
                           
                           $sql="select * from v_servicios_programados where f_id_usuario=".$usuario;
                          }
                               if($connect)
                                  {
                                       ...
                                       { 
                                          ...
                                          {
                                            echo "<tr>";
                                               echo "<td>".$row['id_servicio_programado']."</td>";
