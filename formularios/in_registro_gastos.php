...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Alquimia |  Registro de Gastos</title>
    ...
    <script>
          function buscar(id){
           //alert("Entro id "+id);
            $.ajax({ 
                type: "POST", 
                url: "../funciones_PHP/buscar_propiedades.php", 
                data: {id: id}
    ...
    function clearAll(){
      ...
      document.getElementById('text_servicio').value="";
    ...
    function validar(){
       var count = 0;
        /* Login page */
        var  a = document.getElementById('text_id').value;
        //alert("Cojio el valor"); 
        if (a === ''){
            count = count + 1;
            document.getElementById('text_id').style.borderColor = "red";
            document.getElementById('text_id').placeholder = "Dede Completar Este Campo";
        }else{document.getElementById('text_id').style.borderColor = "gray";}
        ...
        if (a === ''){
            ...
            document.getElementById('text_servicio').placeholder = "Dede Completar Este Campo";
    ...
    function salvarPago(){
        if (validar()){
         ...
         $.ajax({ 
          type: "POST", 
          url: "../funciones_PHP/pagar_gastos.php", 
          data: "propiedad="+document.getElementById("text_id").value+"&detalle="+document.getElementById("text_detalle").value+
          "&monto="+document.getElementById("text_monto").value+"&servicio="+document.getElementById("text_servicio").value+
          "&fecha="+document.getElementById("text_fecha").value+
          "&id="+"<?php echo $usuario ?>"
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-2">
                        <div class="form-group">
                          <label for="exampleInputEmail1">ID Propiedad</label>
                          <input type="text" class="form-control" 
                          name="campo_id_cliente" id="text_id" onchange="buscar(this.value)">
                        </div>
                      </div>
                       ...
                       <div class="col-md-10">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" 
                          name="campo_nombre_cliente" id="text_desc" readonly>
                        </div>
                      </div>
                     ...
                     <div class="row">
                      ...
                      <div class="col-md-4">
                       <div class="form-group">
                        <label for="exampleInputEmail1">Gasto</label>
                          <select class="form-control select" name="campo_documento" id="text_servicio">
