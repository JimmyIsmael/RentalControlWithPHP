 ...
 <?php
       ...
       // $puesto=$_SESSION['puesto'];
        ...
        if ($_SESSION["id"]!=""){
          ...
          $sql="select * from t_gastos where f_id='$id'";                                       
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Control Sales | Gastos</title>
            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Entrada de Gastos</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form name="formulario" action="../funciones_PHP/salvar_gastos.php" method="post"
                 onsubmit="return validar()">
                  ...
                  <div class="box-footer">
                     <form action='out_gastos.php'>
                        <input class="btn btn-primary" type="button" value="Cancelar" onClick=" window.location.href='out_gastos.php' ">
                     </form>  
