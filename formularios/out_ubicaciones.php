...
<html>
  <head>
    <meta charset="UTF-8">
    <title>FinancialControl | Ubicaciones</title>
    ...
    <script>
      ...
      xmlhttp.open("POST","../funciones_PHP/consulta_ubicaciones.php",true);
        ...
        <div class="col-md-8">
          <div class="box box-primary">
              ...
              <form name="formulario" method="POST" >
                <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input  class="form-control"  placeholder="Descripcion del Servicio" 
                      name="campo_desc" id="descripcion" onchange="mostrarInfo(this.value)" autocomplete="off">
                  </div>
                </div><!-- /.col -->
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-6">
                   <div class="form-group">
                    <form action='in_ubicaciones.php'>
