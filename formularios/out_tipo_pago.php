...
<html>
  <head>
    <meta charset="UTF-8">
    <title>FinancialControl | Tipos Propiedades</title>
    ...
    <![endif]-->
      ...
      xmlhttp.open("POST","../funciones_PHP/consulta_tipo_propiedades.php",true);
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="descripcion" onchange="mostrarInfo(this.value)" autocomplete="off">
                  </div>
                </div><!-- /.col -->
