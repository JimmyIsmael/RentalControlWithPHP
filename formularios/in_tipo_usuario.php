...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Control Sales | Tipos Usuario</title>
            ...
            <div class="col-md-8">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Entrada de Tipos de Usuario</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form name="formulario" action="../funciones_PHP/salvar_tipos_usuarios.php" method="post"
                 onsubmit="return validar()">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="campo_desc" id="text_desc"/>
                        </div><!-- /.input group -->
                      </div><!-- /.form group -->
                    </div>
                  </div>
                  ...
                  <div class="box-footer">
                     <form action='out_tipo_usuario.php'>
                        <input class="btn btn-primary" type="button" value="Cancelar" onClick=" window.location.href='out_tipo_usuario.php' ">
                     </form>  
